...
runCountdown2 n = run $ runState (n :: Int) $ runFail $ countdown
    ...
    \subsection{Building parsers with extensible effects}
      ...
      Consider basic primitive of the library ---
      function that consumes a single item of input stream.
...
item = do
  ...
  case s of [] -> die
      ...
      The type of this function declares effects performed by this function:
      ...
      \texttt{Eff r a} is a free monad constructed on top of functor~\texttt{r}
